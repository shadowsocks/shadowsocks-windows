...
namespace Shadowsocks.Core.Encryption
{
        ...
        : IVEncryptor, IDisposable
    {
        ...
        protected override void cipherUpdate(bool isCipher, int length, byte[] buf, byte[] outbuf)
        {
            ...
            lock(sodiumBuf)
            {
                ...
                {
                    case CIPHER_SALSA20:
                        Sodium.crypto_stream_salsa20_xoric(sodiumBuf, sodiumBuf, (ulong)(padding + length), iv, ic, _key);
                        break;
                    case CIPHER_CHACHA20:
                        Sodium.crypto_stream_chacha20_xoric(sodiumBuf, sodiumBuf, (ulong)(padding + length), iv, ic, _key);
                        break;
                    case CIPHER_CHACHA20_IETF:
                        Sodium.crypto_stream_chacha20_ietf_xoric(sodiumBuf, sodiumBuf, (ulong)(padding + length), iv, (uint)ic, _key);
                        break;
                }
