...
using Shadowsocks.Core.Encryption;

namespace UnitTestProject1
{
    [TestClass]
    public class EncryptionTestCompatible
    {
        private HIPerformanceTimer tmr = new HIPerformanceTimer();
        [TestMethod]
        public void TestMD5()
        {
        ...
        private void RunSingleSodiumEncryptionThread()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < 50; i++)
                {
                    ...
                    IEncryptor encryptor;
                    IEncryptor decryptor;
                    encryptor = new SodiumEncryptor("chacha20", "barfoo!", false, false);
                    decryptor = new SodiumEncryptor("chacha20", "barfoo!", false, false);
                    RunEncryptionRound(encryptor, decryptor);
                }
                for (int i = 0; i < 50; i++)
                {
                    ...
                    IEncryptor encryptor;
                    IEncryptor decryptor;
                    encryptor = new SodiumEncryptor("chacha20-ietf", "barfoo!", false, false);
                    decryptor = new SodiumEncryptor("chacha20-ietf", "barfoo!", false, false);
                    RunEncryptionRound(encryptor, decryptor);
                }
            }
            catch
